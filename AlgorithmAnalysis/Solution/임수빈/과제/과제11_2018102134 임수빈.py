# 분기한정 가지치기 깊이우선검색 방법으로 0-1 배낭문제를 해결하는 알고리즘을 python으로 완성하라.
...
#-----------------2번------------------#
# (2) 36,37쪽: [실습과제]
# 분기한정 가지치기 최고우선검색 방법으로 0-1 배낭문제를 해결하는 알고리즘을 python으로 완성하라.
print("\n--------------------2번---------------------------\n")
...
class Node:
        ...
        def __repr__(self):
            s = "node : level:{0}, weight:{1}, profit:{2}, bound:{3}".format(self.level, self.weight, self.profit, self.bound)
            return s
